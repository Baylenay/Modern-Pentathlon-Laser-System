...
The second half of this project was to adapt an air pistol by replacing the gas cylinder with a 3D printed replica. The replica contains a laser module which is triggered by a vibration sensor next to the trigger mechanism.
